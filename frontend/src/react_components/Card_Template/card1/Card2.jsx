...
const Card2 = ({ contactData, primaryActionData,secondaryActionData, selectedImage ,selectedLogo,selectedProfile, primaryActionBtns,
  ...
  return (
    <div className="right bg-gray-900 w-full lg:w-[45%] flex justify-center ">
  ...
  {selectedProfile && (
    <img src={selectedProfile} className="absolute h-14 w-20" />
      ...
      <div className={`  ml-12 mt-1 ${selectedLogo ? '' : 'bg-white'}`}>
  {/* Align image */}
  {selectedLogo && (
...
{secondaryActionData.linkdin && (
  ...
  <div className='footer bg-visit_desk_green  rounded-bl-3xl rounded-br-3xl'></div>
  </div></div></div>
